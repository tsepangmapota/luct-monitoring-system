...
export default function LecturerDashboard({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}><Text style={styles.welcome}>{userData?.name || 'Program Leader'}</Text>
      ...
      <View style={[styles.card, { backgroundColor: '#4CAF50' }]}><Text style={styles.cardTitle}>Program Leader Dashboard</Text></View>
    </View>
  );
}
